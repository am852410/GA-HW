...
This assignment spans over the next week.

There will not be another homework assignment assigned next Wednesday to give an ample amount of time for this assignment before Project 2!

**After Saturday's Lesson, you should work on having:**
- The app setup, the database connected, the index and show page and new/create page done

**After the Tuesday/Wednesday Lessons, you should work on having:**
- Have delete, update, buy button, router and some css added.
