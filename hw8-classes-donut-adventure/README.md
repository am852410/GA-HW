...
1. Make a file called `objects.js` and do the first few sections up until the Daring Adventure in this file
...
1. Create a folder called `donut_adventure`
...
- Submit your homework via pull request before class starts tomorrrow
